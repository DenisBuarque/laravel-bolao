        ...
        <div class="col-md-8 col-md-offset-2">
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    Formulário adicionar cargo ou função
                ...
                <div class="panel-body">
                    ...
                    <form method="POST" action="{{ route('admin.roles.store') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="name" value="{{ old('name') }}" class="form-control" autofocus id="" placeholder="">
                                @if ($errors->has('name'))
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="description" value="{{ old('description') }}" class="form-control" id="" placeholder="">
