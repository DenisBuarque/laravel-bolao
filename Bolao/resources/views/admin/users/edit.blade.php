                ...
                @endif
                    ...
                    <form method="POST" action="{{ route('admin.users.update', $usuario->id ) }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="name" value="{{ old('name') ? old('name') : $usuario->name }}" class="form-control" required autofocus id="nameForm" placeholder="">
                                @if ($errors->has('name'))
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="email" value="{{ old('email') ? old('email') : $usuario->email }}" class="form-control" required id="emailForm" placeholder="">
                                @if ($errors->has('email'))
                                    <span class="help-block">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="password" name="password" class="form-control" id="passForm" placeholder="">
