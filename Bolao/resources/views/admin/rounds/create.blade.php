        ...
        <div class="col-md-8 col-md-offset-2">
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    Formulário adicionar rodada
                    <a href="{{ route('admin.rounds.index') }}" class="pull-right">Lista de Registros</a>
                </div>

                <div class="panel-body">

                    <form method="POST" action="{{ route('admin.rounds.store') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="date" name="date_start" value="{{ old('date_start') }}" class="form-control" required autofocus id="tartFor" placeholder="">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="date" name="date_end" value="{{ old('date_end') }}" class="form-control" required autofocus id="endFor" placeholder="">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="time" name="clock" value="{{ old('clock') }}" class="form-control" required autofocus id="clockFor" placeholder="">
                                @if ($errors->has('clock'))
                                    <span class="help-block">
